...
const ja: Record<string, string> = {
  ...
  "콜센터 직원 계정과 현재 상태를 관리합니다.": "コールセンタースタッフのアカウントと現在の状態を管理します。", "호텔과 객실, 고객 접속 QR을 한곳에서 관리합니다.": "ホテル・客室・GuestアクセスQRを一か所で管理します。", "종료된 상담을 호텔별로 찾아 전체 대화를 확인합니다.": "終了した相談をホテル別に検索し、会話全体を確認します。",
