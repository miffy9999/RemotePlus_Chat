...
const ja: Record<string, string> = {
  ...
  "로그인 ID": "ログインID", "비밀번호": "パスワード", "로그인 중…": "ログイン中…", "서버 깨우는 중…": "サーバー起動中…", "무료 서버를 깨우는 중입니다. 첫 연결은 약 1분 걸릴 수 있습니다.": "無料サーバーを起動しています。最初の接続には約1分かかる場合があります。", "로그인": "ログイン", "아이디 저장": "IDを保存", "로그인 정보 저장": "ログイン情報を保存", "로그인 정보 저장 방식": "ログイン情報の保存方法", "로그인 정보 저장은 브라우저 비밀번호 관리자를 사용합니다. 선택한 버튼을 다시 누르면 해제됩니다.": "ログイン情報の保存にはブラウザのパスワードマネージャーを使用します。選択中のボタンをもう一度押すと解除できます。",
  ...
  "새 상담이 도착했습니다.": "新しい相談が届きました。", "고객 메시지가 도착했습니다.": "宿泊者からメッセージが届きました。", "대기 상담 보기": "待機中の相談を見る", "알림음 켜기": "通知音をオン", "알림음 끄기": "通知音をオフ", "브라우저 알림 켜기": "ブラウザ通知を有効にする", "브라우저 알림 켜짐": "ブラウザ通知：有効", "브라우저 알림 차단됨": "ブラウザ通知：ブロック中", "브라우저 알림이 켜졌습니다.": "ブラウザ通知を有効にしました。", "탭이 백그라운드여도 새 상담과 메시지를 알려드립니다.": "タブがバックグラウンドでも、新しい相談とメッセージを通知します。", "브라우저 알림 등록에 실패했습니다. HTTPS 주소와 사이트 알림 권한을 확인하세요.": "ブラウザ通知の登録に失敗しました。HTTPS URLとサイトの通知権限を確認してください。", "브라우저 알림이 차단되었습니다.": "ブラウザ通知がブロックされています。", "Edge 주소창의 사이트 정보에서 알림 권한을 허용한 뒤 새로고침하세요.": "Edgeのアドレスバーにあるサイト情報から通知を許可し、再読み込みしてください。", "알림 닫기": "通知を閉じる",
  "호텔": "ホテル", "객실": "客室", "언어": "言語", "상태": "状態", "만료 시각": "有効期限", "수락 후 15분": "受付後15分", "작업": "操作", "표시할 상담이 없습니다.": "表示する相談はありません。", "호 상담": "号室の相談",
